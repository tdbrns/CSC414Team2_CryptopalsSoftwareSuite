...
inline string ChallengeSolver::HexToBase64(string hexString)
{
    try 
    {
        // Input validation
...
inline string ChallengeSolver::FixedXOR(string hexString1, string hexString2)
{
...
inline string ChallengeSolver::SingleByteXORCipher(string hexString)
{
    try
    {
        // Input validation
...
inline string ChallengeSolver::DetectSingleCharXOR(vector<string> hexCiphertexts)
{
    try
    {
        // Input validation
...
inline string ChallengeSolver::RepeatingKeyXOR(string plain_text, string key)
{
    try
    {
...
inline string ChallengeSolver::BreakRepeatingKeyXOR(Block base64Text)
{
    try
    {
        // Input validation
...
inline string ChallengeSolver::AES_ECBMode(Block base64Text)
{
    try
    {
        // Input validation
...
inline string ChallengeSolver::DetectAES_ECBMode(vector<Block> hexCiphertexts)
{
    try
    {
        // Input validation
